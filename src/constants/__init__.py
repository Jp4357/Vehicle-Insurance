...
AWS_ACCESS_KEY_ID_ENV_KEY = os.getenv("AWS_ACCESS_KEY_ID")  # "AWS_ACCESS_KEY_ID"
AWS_SECRET_ACCESS_KEY_ENV_KEY = os.getenv(
...
MODEL_BUCKET_NAME = os.getenv("AWS_S3_BUCKET_NAME")
